...
export const PhoneInput = ({ id, label, placeholder, readOnly, horizontal, country = 'us' }: PhoneInputProps) => {
  const {
    control,
    getValues,
    formState: { errors }
  ...
  return (
    <Group label={label} id={id} error={formError?.message as unknown as string | undefined} center>
      <PhoneInputNative
        country={country}
