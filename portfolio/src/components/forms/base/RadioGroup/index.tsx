...
export const RadioGroup = ({ id, options, label, horizontal, helperText, readOnly }: RadioGroupProps) => {
  const {
    control,
    watch,
    formState: { errors }
  ...
  return (
    <InputGroup id={id} label={label} helperText={helperText} error={formError?.message as unknown as string | undefined}>
