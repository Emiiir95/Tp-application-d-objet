...
export const Form = <T extends FieldValues>(props: FormProps<T>) => {
  const { className, children, render, onSubmit, defaultValues, schema, onlyTouchedFields, resetOnSubmit, logErrors, mode = 'onSubmit', ...rest } = props;
  ...
  const { handleSubmit, formState, setValue, reset } = useFormProps;
